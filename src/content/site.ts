// Visi svetainės tekstai vienoje vietoje – iš public/texts.docx.
// Keičiant turinį pakanka redaguoti šį failą.
...
export const nav = [
  { label: "Pradžia", to: routes.home },
  { label: "Kas esu", to: routes.kasEsu },
  { label: "Kur kviečiu ir kuo tikiu", to: routes.kurKvieciu },
  { label: "DUK", to: routes.duk },
  { label: "Susisiekime", to: routes.susisiekime },
];

export const ctaLabel = "SUSISIEKIME";
